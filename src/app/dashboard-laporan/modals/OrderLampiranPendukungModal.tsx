...
import { LampiranDataPendukung } from "@/app/_types/types";
import {
  ArrowUpIcon,
  ArrowDownIcon,
  XMarkIcon,
...
export default function OrderLampiranPendukungModal({
  lampirans,
  moveItem,
  onClose,
  onSave,
        ...
        <div className="overflow-x-auto overflow-y-auto max-h-[60vh] border border-gray-200">
          <table className="w-full text-sm text-gray-700 border-collapse">
            <thead className="bg-gray-100 sticky top-0 z-10">
              <tr>
                <th className="p-3 border font-medium text-center">No</th>
                <th className="p-3 border font-medium text-center">Urutan</th>
                <th className="p-3 border font-medium text-left">Judul</th>
                <th className="p-3 border font-medium text-center">
                  Jumlah Total Lembar
                </th>
            ...
            <tbody>
              {lampirans.map((item, index) => (
                ...
                >
                  ...
                  <td className="border px-3">{item.jumlahTotalLembar}</td>
                  ...
                  <td className="border text-center">
                    <div className="flex justify-center gap-2">
                      ...
                      <button
                        ...
                        disabled={index === lampirans.length - 1}
                        className="p-2 rounded hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed transition"
                      >
